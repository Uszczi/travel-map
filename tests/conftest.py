...
PIOTRKOWSKA_START_X = 19.19618368148804
PIOTRKOWSKA_START_Y = 51.61393949799736
PIOTRKOWSKA_START_X_Y = (PIOTRKOWSKA_START_X, PIOTRKOWSKA_START_Y)
PIOTRKOWSKA_START_Y_X = (PIOTRKOWSKA_START_Y, PIOTRKOWSKA_START_X)
...
@pytest.fixture()
def end_node(graph):
    return ox.nearest_nodes(graph, X=PIOTRKOWSKA_START_X, Y=PIOTRKOWSKA_START_Y)
