...
docker compose -f ./deployment/docker-compose.yml up --detach db
docker compose -f ./deployment/docker-compose.yml run --rm --no-deps app python -c "from app.settings import settings; print(settings.ENV)"
